...
export const Season = () => {
  ...
  const submitForm = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setProjectedTableInfo(
      await getProjectedSeason(playerFullName, playerSeason)
    );
    setpitchingTableInfo(
      await getSeasonPlayerPitching(playerFullName, playerSeason)
    );
  };
  ...
  const [pitchingTableInfo, setpitchingTableInfo] =
    useState<SeasonPitchingProps>({
      era: "",
      so: "",
      bb: "",
      kbb: "",
            ...
            <form name="player-info" id="player-info" onSubmit={submitForm}>
              <div className="container">
                ...
                <input
                  ...
                  className="searchbar"
                  type="text"
                  onChange={(i) => setPlayerSeason(i.target.value)}
